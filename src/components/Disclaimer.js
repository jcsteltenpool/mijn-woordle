        ...
        <div className="content-modal">
            <div className="content-modal-panel-wrapper">
                <div className="content-modal-panel privacy">
                    ...
                    <h3>Donatie</h3>
                    <p>Raad Het Woord is volledig gratis om te gebruiken maar kost wel tijd en geld om online te houden. Joost Steltenpool is dan ook niet vies van een blijk van waardering, en ook niet van een kop koffie. <br/>Doneer via onderstaande knop!</p>
                    <div className="flex">
                        {buymeacoffee}
                    </div>
                </div>
