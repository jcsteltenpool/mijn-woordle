        ...
        <div className="content-modal">
            <div className="content-modal-panel-wrapper">
                <div className="content-modal-panel privacy">
                    ...
                    <h3>Donatie</h3>
                    <p>Raad Het Woord is onbeperkt gratis te spelen. Het kost echter wel tijd en geld om online te houden.<br/>Als je blij wordt van het spelen van Raad Mijn Woord, doneer dan wat je kan missen om Joost Steltenpool te laten weten dat je zijn werk waardeert. <br/>Hij is je er zeer dankbaar voor!</p>
